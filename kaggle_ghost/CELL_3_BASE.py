# ============================================
# CELL 3 — DOWNLOAD BASE MODEL (fp16)
# ============================================
# Same F32 → fp16 conversion for Base model
# (57.6GiB disk = enough for both Turbo + Base!)
...
print("="*55)
print("  CELL 3: BASE MODEL (fp16)")
print("="*55)
t0 = time.time()

BASE = "https://huggingface.co/Tongyi-MAI/Z-Image/resolve/main"
DIR = "/kaggle/working/models/Z-Image-Base"
TMP = "/kaggle/working/.tmp2"

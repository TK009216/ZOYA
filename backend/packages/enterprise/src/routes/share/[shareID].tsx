import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@zoya/sdk/v2"
import { SessionTurn } from "@zoya/ui/session-turn"
import { SessionReview } from "@zoya/ui/session-review"
import { DataProvider } from "@zoya/ui/context"
import { FileComponentProvider } from "@zoya/ui/context/file"
import { WorkerPoolProvider } from "@zoya/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@zoya/ui/logo"
import { IconButton } from "@zoya/ui/icon-button"
import { ProviderIcon } from "@zoya/ui/provider-icon"
import { iife } from "@zoya/core/util/iife"
import { Binary } from "@zoya/core/util/binary"
import { NamedError } from "@zoya/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@zoya/ui/tabs"
import { MessageNav } from "@zoya/ui/message-nav"
import { FileSSR } from "@zoya/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@zoya/ui/pierre/worker").then((m) => ({

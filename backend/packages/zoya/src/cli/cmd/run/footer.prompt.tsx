...
import { normalizePromptContent } from "@zoya/tui/editor"
...
import { OPENCODE_BASE_MODE, useBindings } from "@zoya/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close ZOYA" } satisfies SlashOption,
    ]

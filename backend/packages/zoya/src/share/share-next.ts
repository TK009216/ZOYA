...
import type * as SDK from "@zoya/sdk/v2"
...
import { SessionShareTable } from "@zoya/core/share/sql"
...
export class Service extends Context.Service<Service, Interface>()("@zoya/ShareNext") {}

...
import { path } from "@zoya/core/effect/layer-node-platform"
...
import type { ProjectV2 } from "@zoya/core/project"
...
export class Service extends Context.Service<Service, Interface>()("@zoya/Worktree") {}

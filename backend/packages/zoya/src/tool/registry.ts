...
export class Service extends Context.Service<Service, Interface>()("@zoya/ToolRegistry") {}
  ...
  Effect.gen(function* () {
    ...
    const tools: Interface["tools"] = Effect.fn("ToolRegistry.tools")(function* (input) {
      const filtered = (yield* all()).filter((tool) => {
        ...
        const usePatch = input.providerID === "openai" && !input.modelID.includes("oss") && !input.modelID.includes("gpt-4")

...
import { TuiKeybind } from "@zoya/tui/config/keybind"
...
import { TuiConfig } from "@zoya/tui/config"
...
export class Service extends Context.Service<Service, Interface>()("@zoya/TuiConfig") {}

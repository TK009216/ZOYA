...
import { createZoyaClient } from "@zoya/sdk"
...
import { InstallationChannel } from "@zoya/core/installation/version"
...
export class Service extends Context.Service<Service, Interface>()("@zoya/Plugin") {}

...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@zoya/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@zoya/ACPDirectory") {}

...
import { Hash } from "@zoya/core/util/hash"
...
import { optionalOmitUndefined } from "@zoya/core/schema"
...
const BUNDLED_PROVIDERS: Record<string, () => Promise<(opts: any) => BundledSDK>> = {
  ...
  "@ai-sdk/github-copilot": () =>
    import("@zoya/core/github-copilot/copilot-provider").then((m) => m.createOpenaiCompatible),
      ...
      if (!apiToken) {
        throw new Error(
          "CLOUDFLARE_API_TOKEN (or CF_AIG_TOKEN) is required for Cloudflare AI Gateway. " +
            "Set it via environment variable or run `zoya auth cloudflare-ai-gateway`.",
        )
      }
...
export class Service extends Context.Service<Service, Interface>()("@zoya/Provider") {}
  ...
  Effect.gen(function* () {
    ...
    const getSmallModel = Effect.fn("Provider.getSmallModel")(function* (providerID: ProviderV2.ID) {
      ...
      const priority = providerID.startsWith("opencode")
        ? ["deepseek-v4-flash-free", "gpt-5-nano"]

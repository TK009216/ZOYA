...
import { InstallationChannel, InstallationVersion } from "@zoya/core/installation/version"
import { NpmConfig } from "@zoya/core/npm-config"
...
export class Service extends Context.Service<Service, Interface>()("@zoya/Installation") {}

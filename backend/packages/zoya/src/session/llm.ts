...
import { llmClient } from "@zoya/core/effect/layer-node-platform"
...
import type { LLMEvent } from "@zoya/llm"
import { LLMClient, RequestExecutor, WebSocketExecutor } from "@zoya/llm/route"
import type { LLMClientService } from "@zoya/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@zoya/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @zoya/llm. It

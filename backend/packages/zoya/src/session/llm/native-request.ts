import type { JsonSchema, LLMRequest, ProviderMetadata } from "@zoya/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@zoya/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @zoya/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({

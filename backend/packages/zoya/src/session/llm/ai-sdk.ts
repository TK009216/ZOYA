import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@zoya/llm"
...
// Move this extraction into @zoya/llm when Copilot is handled by the native runtime.

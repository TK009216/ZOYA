...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new ZoyaClient()" to fix this error.`)
    }
    return instance
  }
...
export class ZoyaClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<ZoyaClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    ZoyaClient.__registry.set(this, args?.key)
  }

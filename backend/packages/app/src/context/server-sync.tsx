import type { Config, ZoyaClient, Path, Project, ProviderAuthResponse, Todo } from "@zoya/sdk/v2/client"
...
import { createSimpleContext, NormalizedProviderListResponse } from "@zoya/ui/context"
...
export const loadMcpQuery = (scope: ServerScope, directory: string, sdk: ZoyaClient) =>
  queryOptions({
    queryKey: [scope, directory, "mcp"] as const,
    queryFn: () => sdk.mcp.status().then((r) => r.data ?? {}),
  })

export const loadLspQuery = (scope: ServerScope, directory: string, sdk: ZoyaClient) =>
  queryOptions({
...
export function createServerSyncContextInner(_serverSDK?: ServerSDK) {
  ...
  const sdkCache = new Map<string, ZoyaClient>()

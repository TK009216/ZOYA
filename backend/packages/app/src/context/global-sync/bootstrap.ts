...
import { NormalizedProviderListResponse } from "@zoya/ui/context"
...
export const loadGlobalConfigQuery = (scope: ServerScope, sdk: ZoyaClient) =>
  queryOptions({
    queryKey: [scope, "config"],
    queryFn: () => retry(() => sdk.global.config.get().then((x) => x.data!)),
  })

export const loadProjectsQuery = (scope: ServerScope, sdk: ZoyaClient) =>
  queryOptions({
...
export const loadProvidersQuery = (scope: ServerScope, directory: string | null, sdk: ZoyaClient) =>
  queryOptions({
    queryKey: [scope, directory, "providers"],
    queryFn: () => retry(() => sdk.provider.list().then((x) => normalizeProviderList(x.data!))),
  })

export const loadAgentsQuery = (scope: ServerScope, directory: string | null, sdk: ZoyaClient) =>
  queryOptions({
    queryKey: [scope, directory, "agents"],
    queryFn: () => retry(() => sdk.app.agents().then((x) => normalizeAgentList(x.data))),
  })

export const loadPathQuery = (scope: ServerScope, directory: string | null, sdk: ZoyaClient) =>
  queryOptions<Path>({

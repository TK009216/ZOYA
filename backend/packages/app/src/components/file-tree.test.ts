...
beforeAll(async () => {
  ...
  mock.module("@zoya/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@zoya/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@zoya/ui/icon", () => ({ Icon: () => null }))
  mock.module("@zoya/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))

import type { TuiPluginApi } from "@zoya/plugin/tui"
...
const TIPS: Tip[] = [
  ...
  "Create a plugin to prevent ZOYA from reading sensitive files",
  "Use {highlight}zoya run{/highlight} for non-interactive scripting",
  "Use {highlight}zoya --continue{/highlight} to resume the last session",
  "Use {highlight}zoya run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}zoya serve{/highlight} for headless API access to ZOYA",
  "Use {highlight}opencode run --attach{/highlight} to connect to a running server",
  "Run {highlight}zoya upgrade{/highlight} to update to the latest version",
  "Run {highlight}zoya auth list{/highlight} to see all configured providers",
  "Run {highlight}zoya agent create{/highlight} for guided agent creation",
  "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}zoya github install{/highlight} to set up the GitHub workflow",
  ...
  "Run {highlight}zoya debug config{/highlight} to troubleshoot configuration",
  ...
  "Use {highlight}/connect{/highlight} with ZOYA Pro for curated, tested models",

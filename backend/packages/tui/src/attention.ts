...
import defaultSoundPath from "@zoya/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@zoya/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@zoya/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@zoya/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@zoya/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@zoya/ui/audio/yup-01.mp3" with { type: "file" }

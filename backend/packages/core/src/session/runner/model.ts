...
import { type Model } from "@zoya/llm"
import * as AnthropicMessages from "@zoya/llm/protocols/anthropic-messages"
import * as OpenAICompatibleChat from "@zoya/llm/protocols/openai-compatible-chat"
import * as OpenAIResponses from "@zoya/llm/protocols/openai-responses"
import { Auth, type AnyRoute } from "@zoya/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@zoya/v2/SessionRunnerModel") {}

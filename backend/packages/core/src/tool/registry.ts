...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@zoya/llm"
...
export class Service extends Context.Service<Service, Interface>()("@zoya/v2/ToolRegistry") {}

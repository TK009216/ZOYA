...
export const TypeId: TypeId = "~@zoya/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@zoya/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@zoya/effect-sqlite-node/NodeSqliteClient")

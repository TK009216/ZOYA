/**
 * @license
 * Copyright 2025 ZOYA (aionui.com)
...
interface IChatConversation<T, Extra> {
  ...
  /** 会话来源，默认为 ZOYA / Conversation source, defaults to ZOYA */
...
export interface IMcpServer {
  ...
  /** Built-in MCP server managed by ZOYA (hide edit/delete in UI) */
  builtin?: boolean;
}
...
export const BUILTIN_IMAGE_GEN_NAME = 'ZOYA-Image-Generation';
export const BUILTIN_IMAGE_GEN_LEGACY_NAMES = ['ZOYA Image Generation', BUILTIN_IMAGE_GEN_ID] as const;

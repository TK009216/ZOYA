...
import natureThemeCss from '@renderer/pages/settings/AppearanceSettings/presets/nature-theme.css?raw';
import midnightThemeCss from '@renderer/pages/settings/AppearanceSettings/presets/midnight-theme.css?raw';
...
export const BUILTIN_THEMES: Theme[] = [
  ...
  decorative('nature-green', 'Nature', 'light', natureThemeCss),
  decorative('midnight-purple', 'Midnight', 'dark', midnightThemeCss),
];

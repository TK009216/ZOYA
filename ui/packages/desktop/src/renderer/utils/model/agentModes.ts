...
export const AGENT_MODES: Record<string, AgentModeOption[]> = {
  ...
  zoya: [
    { value: 'fast', label: '⚡ Fast', description: 'Speed-first, concise replies, minimal detail' },
    { value: 'pro', label: '🔧 Pro', description: 'Balanced depth, detailed with good structure' },
    { value: 'expert', label: '🧠 Expert', description: 'Maximum depth, comprehensive analysis, thorough explanations' },
  ],
  gemini: [
    { value: 'default', label: 'Default' },

export const WORKSPACE_TOGGLE_EVENT = 'zoya-workspace-toggle';
export const WORKSPACE_STATE_EVENT = 'zoya-workspace-state';
export const WORKSPACE_HAS_FILES_EVENT = 'zoya-workspace-has-files';

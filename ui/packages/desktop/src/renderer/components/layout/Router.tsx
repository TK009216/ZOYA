...
const ZoyaModelSettings = React.lazy(() => import('@renderer/pages/settings/ZoyaModelSettings'));
const AgentGroupsSettings = React.lazy(() => import('@renderer/pages/settings/AgentGroupsSettings'));

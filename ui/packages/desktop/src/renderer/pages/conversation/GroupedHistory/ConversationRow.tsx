    ...
    if (assistantInfo) {
      ...
      return (
        <img
          ...
          className={classNames('w-24px h-24px rounded-50% flex-shrink-0 object-contain', composedClass)}
        />
      );
    }
    ...
    if (logo) {
      return (
        <img
          ...
          className={classNames('w-32px h-32px rounded-50% flex-shrink-0 object-contain', composedClass)}
        />
      );
    }
    ...
    >
      <div
        ...
        className={classNames(
          'chat-history__item h-44px rd-8px flex items-center group cursor-pointer relative overflow-hidden shrink-0 conversation-item [&.conversation-item+&.conversation-item]:mt-2px min-w-0 transition-colors',
      ...
      >
        ...
        <span className='size-34px flex items-center justify-center shrink-0 relative'>
